...
class SettingRepository extends BaseRepository
{
     ...
     */
     public function getSetList(){
           return Cache::remember('setting_set_list', Config::get('web.cachetime'), function(){

                return Setting::where('name','like','%menu_option%')->get();

           });
     }

    public function  getSetObj($name)
    {
           return Cache::remember('setting_set_obj'.$name, Config::get('web.cachetime'), function() use ($name){
