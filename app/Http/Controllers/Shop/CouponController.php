...
class CouponController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        $products=[];
        $specs=[];
        return view('shop.coupons.create', compact('categories', 'level01', 'level02', 'level03', 'level02Selections','products','specs' ,'level03Selections','add_spec_product','add_product_id'));
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.coupons.show')->with('coupon', $coupon);
    }
    */
    /**
    ...
    public function edit($id)
    {
        ...
        return view('shop.coupons.edit', compact('coupon', 'categories', 'level01', 'level02', 'level03', 'level02Selections', 'level03Selections','products','specs'));
    }
    ...
    public function given()
    {
        ...
        $coupons = Coupon::all();
        $selectedCoupons = [];
        return view('shop.coupons.given_onebyone',compact('users', 'coupons', 'selectedCoupons'));
    }
    ...
    public function givenUserList(Request $request){
        ...
        return view('shop.coupons.given_userlist',compact('tools','users', 'users_num','input','users_level'));
    }
    ...
    public function givenInteger(UserLevelRepository $userLevelRepo)
    {
        ...
        $coupons = Coupon::all();
        $selectedCoupons = [];
        return view('shop.coupons.given', compact('user_levels', 'coupons', 'selectedCoupons'));
    }
    ...
    {
        return view('shop.coupons.stats');
    }
