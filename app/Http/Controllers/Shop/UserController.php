...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
    	...
    	return view('shop.user.index', compact('tools','users','users_level','input'));
    }
    ...
    public function show($id)
    {
        ...
        //currentTime
        return view('shop.user.show', compact('user','userLevel', 'share_img', 'orders', 'funds', 'credits','messages'));
    }
