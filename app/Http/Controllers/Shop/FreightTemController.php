...
class FreightTemController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.freight_tems.index')
    ...
    {
        $freightTem=null;
        return view('shop.freight_tems.create')->with('freightTem',$freightTem);
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.freight_tems.show')->with('freightTem', $freightTem);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.freight_tems.edit')
