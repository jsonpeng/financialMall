...
class GroupSaleController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.group_sales.index')
    ...
    {
        $product_spec=null;
        return view('shop.group_sales.create')
    ...
    public function show($id)
    {
        ...
        return view('shop.group_sales.show')->with('groupSale', $groupSale);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.group_sales.edit')
