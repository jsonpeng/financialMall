...
class FlashSaleController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.flash_sales.index')
    ...
    {
        $product_spec=null;
        return view('shop.flash_sales.create')
    ...
    public function show($id)
    {
        ...
        return view('shop.flash_sales.show')->with('flashSale', $flashSale);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.flash_sales.edit')
