...
class ProductTypeController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.product_types.index')
    ...
    {
        return view('shop.product_types.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.product_types.show')->with('productType', $productType);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.product_types.edit')->with('productType', $productType);
    }
