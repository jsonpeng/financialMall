...
class CardController extends AppBaseController
{
    ...
    public function show($id)
    {
        ...
        return view('shop.cards.show')->with('card', $card);
    }
