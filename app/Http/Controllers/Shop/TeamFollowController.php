...
class TeamFollowController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.team_follows.index')
    ...
    {
        return view('shop.team_follows.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.team_follows.show')->with('teamFollow', $teamFollow);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.team_follows.edit')->with('teamFollow', $teamFollow);
    }
