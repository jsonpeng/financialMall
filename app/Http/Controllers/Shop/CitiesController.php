...
class CitiesController extends AppBaseController
{
   ...
   // private $roleRepository;
    ...
    public function CitiesSelectFrame(){
        ...
        return view('shop.cities.select')->with('cities_level1',$cities_level1);

    }

    public function ChildList(Request $request,$pid){
        $cities=Cities::where('pid',$pid)->get();
        return view('shop.cities.childlist')
            ->with('pid',$pid)
            ->with('cities', $cities);
    }
    ...
    public function GetFreightTemByCidFrame($cid){
        ...
        $freight_tem=getFreightInfoByCitiesId($cid);
        return view('shop.cities.freight_tem')
    ...
    public function create()
    {
        $pid=1;
        $level=1;
        return view('shop.cities.create')
                ->with('pid',$pid)
                ->with('level',$level);
    }
    ...
    public function ChildCreate($pid){
        ...
        if(!empty($last_cities)) {
         ...
         return view('shop.cities.create_child')
    ...
    public function edit($id)
    {
        ...
        return view('shop.managers.edit')
