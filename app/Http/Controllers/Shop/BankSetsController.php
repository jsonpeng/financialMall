...
class BankSetsController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        //return $bankSets;
        return view('shop.bank_sets.index')
    ...
    {
        $bankSets=null;
        return view('shop.bank_sets.create')->with('bankSets',$bankSets);
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.bank_sets.show')->with('bankSets', $bankSets);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.bank_sets.edit')->with('bankSets', $bankSets);
    }
