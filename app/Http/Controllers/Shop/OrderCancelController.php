...
class OrderCancelController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.order_cancels.index')
    ...
    {
        return view('shop.order_cancels.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.order_cancels.show')->with('orderCancel', $orderCancel);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.order_cancels.edit')->with('orderCancel', $orderCancel);
    }
