...
class StatController extends Controller
{
    ...
    public function index(Request $request) {
        ...
        //return $todayUsers;
    	return view('shop.stat.index', compact('input','show','customItems','customSales','customUsers','todayItems', 'weekItems', 'monthItems', 'todaySales', 'weekSales', 'monthSales', 'todayUsers', 'weekUsers', 'monthUsers'));
    }
