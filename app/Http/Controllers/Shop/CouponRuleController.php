...
class CouponRuleController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.coupon_rules.index')
    ...
    {
        $coupons = Coupon::all();
        return view('shop.coupon_rules.create')->with('coupons', $coupons);
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.coupon_rules.show')->with('couponRule', $couponRule);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.coupon_rules.edit')->with('couponRule', $couponRule)->with('coupons', $coupons)->with('selectedCoupons', $selectedCoupons);
    }
