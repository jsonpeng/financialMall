...
class ThemeController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        return view('shop.themes.create')->with('cats', $cats);
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.themes.show')->with('theme', $theme);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.themes.edit')->with('theme', $theme)->with('cats', $cats)->with('selectedProducts', $selectedProducts);
    }
