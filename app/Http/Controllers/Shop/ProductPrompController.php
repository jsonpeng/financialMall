...
class ProductPrompController extends AppBaseController
{
    ...
    public function prompPageSetView(){
        $page_list=empty(getSettingValueByKey('records_per_page'))?5:getSettingValueByKey('records_per_page');
         return view('shop.product_promps.page_set')
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.product_promps.index')
            ->with('tools',$tools)
    ...
    public function create()
    {
        $product=[];
        $spec=[];
        return view('shop.product_promps.create')
    ...
    public function show($id)
    {
        ...
        return view('shop.product_promps.show')->with('productPromp', $productPromp);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.product_promps.edit')
