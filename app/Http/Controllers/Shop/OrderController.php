...
class OrderController extends AppBaseController
{
    ...
    public function show($id)
    {
        ...
        return view('shop.orders.show', compact('order', 'items','actions','kuaidi'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.orders.edit')->with('order', $order);
    }
        ...
        */
        ...
        if(array_key_exists('order_pay', $inputs)){
            ...
            if (array_key_exists('order_pay', $inputs) && $inputs['order_pay'] == '已支付') {
                ...
                app('commonRepo')->processShopOrder($order, '管理员操作');
            }
        }
    ...
    public function destroy($id)
    {
        ...
        $this->orderRepository->deleteOneOrder($id);
    ...
    public function tripperprintOrder($id){
        ...
        return view('shop.orders.print')->with('order', $order);
    }
    ...
    public function print(Request $request, $id)
    {
        ...
        return view('shop.orders.print', compact('order', 'items','actions'));
    }
