...
class OrderPrompController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.order_promps.index')
    ...
    {
        return view('shop.order_promps.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.order_promps.show')->with('orderPromp', $orderPromp);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.order_promps.edit')->with('orderPromp', $orderPromp);
    }
