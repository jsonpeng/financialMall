...
class RefundMoneyController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.refund_moneys.index')
    ...
    {
        return view('shop.refund_moneys.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.refund_moneys.show')->with('refundMoney', $refundMoney);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.refund_moneys.edit')->with('refundMoney', $refundMoney);
    }
