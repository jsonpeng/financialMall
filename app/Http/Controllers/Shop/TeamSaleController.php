...
class TeamSaleController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.team_sales.index')
    ...
    {
        $product_spec=null;
        return view('shop.team_sales.create')
    ...
    public function show($id)
    {
        ...
        return view('shop.team_sales.show')->with('teamSale', $teamSale);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.team_sales.edit')
