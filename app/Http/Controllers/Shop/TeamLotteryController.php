...
class TeamLotteryController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.team_lotteries.index')
    ...
    {
        return view('shop.team_lotteries.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.team_lotteries.show')->with('teamLottery', $teamLottery);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.team_lotteries.edit')->with('teamLottery', $teamLottery);
    }
