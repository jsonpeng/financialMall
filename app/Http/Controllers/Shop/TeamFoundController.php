...
class TeamFoundController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.team_founds.index')
    ...
    {
        return view('shop.team_founds.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.team_founds.show')->with('teamFound', $teamFound);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.team_founds.edit')->with('teamFound', $teamFound);
    }
