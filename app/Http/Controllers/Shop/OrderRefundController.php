...
class OrderRefundController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.order_refunds.index')
    ...
    {
        return view('shop.order_refunds.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.order_refunds.show')->with('orderRefund', $orderRefund);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.order_refunds.edit')
