...
class SpecController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        return view('shop.specs.create', compact('types'));
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.specs.show')->with('spec', $spec);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.specs.edit', compact('spec', 'types', 'selections'));
    }
