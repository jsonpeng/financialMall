...
class ArticlecatsController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.articlecats.index')
    ...
    {
        return view('shop.articlecats.create')->with('categories', $this->categoryRepository->getRootCatArray());
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.articlecats.show')->with('category', $category);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.articlecats.edit')->with('category', $category)->with('categories', $this->categoryRepository->getRootCatArray($category->id));
    }
