...
class OrderActionController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.order_actions.index')
    ...
    {
        return view('shop.order_actions.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.order_actions.show')->with('orderAction', $orderAction);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.order_actions.edit')->with('orderAction', $orderAction);
    }
