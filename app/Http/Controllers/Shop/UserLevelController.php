...
class UserLevelController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.user_levels.index')
    ...
    {
        return view('shop.user_levels.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.user_levels.show')->with('userLevel', $userLevel);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.user_levels.edit')->with('userLevel', $userLevel);
    }
