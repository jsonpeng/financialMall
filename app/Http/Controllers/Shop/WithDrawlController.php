...
class WithDrawlController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.with_drawls.index')
    ...
    {
        return view('shop.with_drawls.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.with_drawls.show')->with('withDrawl', $withDrawl);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.with_drawls.edit')->with('withDrawl', $withDrawl);
    }
