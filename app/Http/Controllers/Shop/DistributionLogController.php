...
class DistributionLogController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.distribution_logs.index')
    ...
    {
        return view('shop.distribution_logs.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.distribution_logs.show')->with('distributionLog', $distributionLog);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.distribution_logs.edit')->with('distributionLog', $distributionLog);
    }
