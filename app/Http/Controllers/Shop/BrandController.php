...
class BrandController extends AppBaseController
{
    ...
    public function iframe(Request $request){
        ...
        return view('shop.brands.iframe')
            ->with('brands', $brands)
    ...
    {
        return view('shop.brands.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.brands.show')->with('brand', $brand);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.brands.edit')->with('brand', $brand)->with('brands', $this->brandRepository->getBrandArray($id));
    }
