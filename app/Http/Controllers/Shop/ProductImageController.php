...
class ProductImageController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.product_images.index')
    ...
    {
        return view('shop.product_images.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.product_images.show')->with('productImage', $productImage);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.product_images.edit')->with('productImage', $productImage);
    }
