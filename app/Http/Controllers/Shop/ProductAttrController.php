...
class ProductAttrController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('shop.product_attrs.index')
    ...
    public function create()
    {
        ...
        return view('shop.product_attrs.create', compact('types'));
    }
    ...
    public function show($id)
    {
        ...
        return view('shop.product_attrs.show')->with('productAttr', $productAttr);
    }
    ...
    public function edit($id)
    {
        ...
        return view('shop.product_attrs.edit')->with('productAttr', $productAttr)->with('types', $types);
    }
