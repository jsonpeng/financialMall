...
class BannerItemController extends AppBaseController
{
    ...
    public function index(Request $request, $banner_id)
    {
        ...
        return view('banner_items.index')
    ...
    public function create($banner_id)
    {
        ...
        return view('banner_items.create')->with('banner_id', $banner_id)->with('banner', $banner);
    }
    ...
    public function edit($banner_id, $id)
    {
        ...
        return view('banner_items.edit')->with('bannerItem', $bannerItem)->with('banner_id', $banner_id)->with('banner', $banner);
    }
