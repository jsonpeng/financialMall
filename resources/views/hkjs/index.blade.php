...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">黑科技</h1>
        <h1 class="pull-right">
           <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('hkjs.create') !!}">添加</a>
        </h1>
    </section>
    <div class="content">
    ...
    <div style="text-align: center;">{!! $hkjs->appends($input)->links() !!}</div>
@endsection
...
@section('scripts')
    <script type="text/javascript">
        function refreshDate(id){
            ...
            $.ajax({
                url: '/zcjy/ajax/refresh_hkj_date/'+ id,
                type: 'GET',
                data: '',
