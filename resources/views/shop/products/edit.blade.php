                                ...
                                <div class="box box-primary mb10-xs">
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            ...
                                            @include('shop.products.product_level_price')
...
@include('shop.partials.imagemodel_product_spec')

@endsection

@section('scripts')
    @include('shop.products.partials.js')
    @include('shop.products.partials.js_edit')
@endsection