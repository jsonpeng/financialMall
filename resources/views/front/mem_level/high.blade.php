...
@section('content')
    ...
    <div class="weui-tab" style="height: 40px; margin-top: 10px;">
        <div class="weui-navbar">
            <a href="/high_level?type=语音" class="weui-navbar__item @if($type == '语音') weui-bar__item_on @endif">
                语音教程
            </a>
            <a href="/high_level?type=视频" class="weui-navbar__item @if($type == '视频') weui-bar__item_on @endif">
                视频教程
            </a>
        </div>
    </div>
