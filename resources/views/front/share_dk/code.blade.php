...
@section('js')
	<script>
		...
		$(document).ready(function() {
			// $.ajax({
			// 	type: "GET",
			// 	url: 'http://api.kaimusoft.xyz/api/weixin_signature?url='+window.location.href,
			// 	success: function(e) {
			// 		if (e.error_code) {
			// 			alert(e.message);
			// 		} else {
			// 			runShare('{!! $daikuan->name !!}', '', window.location.host+'/share_dk/view/{!! $daikuan->id !!}', '{!! $daikuan->image !!}', e.signature);
			// 		}
			// 	},
			// 	error: function(e) {}
			// })
